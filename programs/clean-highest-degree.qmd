...
highest_degree <- read_excel(
  here::here("data", "raw", "memberData_directory-only.xlsx"), 
...
# detailed data
highest_degree %>%
  write_csv(here("data", "clean", "highest-degree_detailed_directory-only.csv"))

# summarized data
highest_degree %>%
  count(degree_simple, sort = TRUE) %>%
  write_csv(here("data", "clean", "highest-degree_summarized_directory-only.csv"))
